...
public class DeviceAuthService {
    ...
    public DeviceToken createAccessToken(User user, String clientId, String deviceName) {
        ...
        deviceToken.setScopes("drafts:create,drafts:approve,drafts:read,analysis:read,analysis:write,transactions:post,data:import,bills:read,bills:create,bills:approve,tax-export:read");
