...
public class InventorySaleFormPage {
    ...
    private static final String UNIT_PRICE_INPUT = "#unitPrice";
    ...
    public InventorySaleFormPage(Page page, String baseUrl) {
        this.page = page;
        this.baseUrl = baseUrl;
    }

    public InventorySaleFormPage navigate() {
        page.navigate(baseUrl + "/inventory/sale");
    ...
    public void fillUnitPrice(String unitPrice) {
        page.fill(UNIT_PRICE_INPUT, unitPrice);
    }
